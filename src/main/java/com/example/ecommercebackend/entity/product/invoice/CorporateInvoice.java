...
public class CorporateInvoice extends Invoice {
    ...
    public CorporateInvoice(Payment payment, BigDecimal totalAmount, BigDecimal taxAmount, InvoiceType invoiceType, String firstName, String lastName, String username, String countryName, String city,String cityCode,String district,Integer districtId, String addressLine1, String postalCode, String phoneNo, String companyName, String taxNumber, String taxOffice) {
