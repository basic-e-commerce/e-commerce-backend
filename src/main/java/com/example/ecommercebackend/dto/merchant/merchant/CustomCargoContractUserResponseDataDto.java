...
public class CustomCargoContractUserResponseDataDto {
    @JsonProperty("id")
    private String id;
    ...
    public CustomCargoContractUserResponseDataDto(String id, String createdAt, String updatedAt, String providerCode, String username, String name, boolean isActive, String parameters, int version, boolean isC2C, String integrationType, String labelFileType, boolean sharable, boolean isPublic, boolean isDynamicPrice, String priceUpdatedAt, Boolean isDefault) {
        this.id = id;
