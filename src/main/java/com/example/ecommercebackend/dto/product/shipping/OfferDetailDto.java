...
public class OfferDetailDto {
    ...
    public OfferDetailDto(String id, String createdAt, String updatedAt, String amount, String currency, String amountLocal, String currencyLocal, String amountVat, String amountLocalVat, String amountTax, String amountLocalTax, String totalAmount, String totalAmountLocal, String amountOld, String amountLocalOld, String discountRate, String bonusBalance, String offerID, ShipmentDto shipment, String description, boolean isRefund, boolean isCustomAccountCharge, boolean isPayed, String payedVia, String transactionType, String invoiceID, String cancelDescription, boolean isCanceled, String oldBalance, String newBalance, String invoiceOldDebt, String invoiceNewDebt) {
        this.id = id;
