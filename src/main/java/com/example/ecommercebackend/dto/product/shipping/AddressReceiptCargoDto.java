...
public class AddressReceiptCargoDto {
    ...
    public AddressReceiptCargoDto(String id, String createdAt, String updatedAt, String name, String shortName, String email, String phone, String address1, String address2, String cityCode, String cityName, CityDto city, String state, String zip, Integer districtID, String districtName, DistrictDto district, String streetID, String streetName, String countryCode, String countryName, String source, Boolean isDefaultSenderAddress, Boolean isDefaultReturnAddress, Boolean isRecipientAddress, Boolean isInvoiceAddress, Boolean isActive) {
        this.id = id;
